        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <figure class="illustration">
              <img src="/src/assets/images/illustration.png" alt="Image" class="img-fluid">
            </figure>
          </div>
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="team">
              <img src="/src/assets/images/achref.jpg" alt="Image" class="img-fluid">
              <h3>Hamrouni Achref</h3>
              ...
              <p>
                ...
                <a href="https://www.facebook.com/achref.zac/" class="p-2 icon-facebook"></a>
          ...
          <div class="col-lg-4">
            <div class="team">
              <img src="/src/assets/images/amin.jpg" alt="Image" class="img-fluid">
              <h3>Karoui Amin</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut commodi accusantium eveniet nemo maiores deleniti rerum animi, deserunt veniam error.</p>
              <p>
                <span class="d-block mb-2"><strong>Connect on social</strong></span>
